...
<body>
     @if(Session::has('global'))
         <div style="width: 100%; text-align: center; padding: 10px; color: #3c763d; margin-bottom: 10px; font-size: 40px;">{{ Session::get('global') }}</div>    
     @endif
	<div class="welcome">
...
Read more: Dream Theater - Root Of All Evil Lyrics | MetroLyrics 